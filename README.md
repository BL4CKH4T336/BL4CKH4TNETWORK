...
# Cloudflare settings for those who have their own Domain, you can check at folder [image](https://github.com/BL4CKH4T336/BL4CKH4T/tree/master/image) to display other settings
<br>
- SSL/TLS : FULL<br>
...
# Pointing
![Pointing](https://github.com/BL4CKH4T/BL4CKH4T/blob/master/image/pointing.png)
...
- Optional [install OpenVPN + Slowdns +](https://github.com/BL4CKH4T336/BL4CKH4T/tree/master/udp-custom) UDP-Custom by [Exe302](https://gitlab.com/Exe302) + Slowdns by [SL](https://github.com/fisabiliyusri)
- Optional [install Panel Webmin + ADS Block](https://github.com/BL4CKH4T336/BL4CKH4T/tree/master/helium) Helium version 3.0 by [Abi Darwish](https://github.com/abidarwish)
- Optional [install Bot Telegram Xolpanel](https://github.com/BL4CKH4T/BL4CKH4T/tree/master/bot%20telegram%20panel) by [XolvaID](https://github.com/XolvaID)
  
# Menu
![Service Status](https://github.com/BL4CKH4T336/BL4CKH4T/blob/master/image/menu1.png)

# Service Status
![Service Status](https://github.com/BL4CKH4T336/BL4CKH4T/blob/master/image/service1.png)
...
```
sysctl -w net.ipv6.conf.all.disable_ipv6=1 && sysctl -w net.ipv6.conf.default.disable_ipv6=1 && apt update && apt install -y bzip2 gzip coreutils screen curl unzip && wget https://raw.githubusercontent.com/BL4CKH4T/BL4CKH4T/master/setup1.sh && chmod +x setup1.sh && sed -i -e 's/\r$//' setup1.sh && screen -S setup ./setup1.sh
```
